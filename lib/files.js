...
const languageServerInfo = {
  ...
  url: "https://repox.sonarsource.com/sonarsource-public-releases/org/sonarsource/sonarlint/core/sonarlint-language-server/2.16.0.843/sonarlint-language-server-2.16.0.843.jar",
...
exports.requirements = basedir => [languageServerInfo].map(info => {
  return {
